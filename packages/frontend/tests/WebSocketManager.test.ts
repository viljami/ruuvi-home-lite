...
import type { ConnectionStatus, WebSocketManagerConfig } from '../src/managers/WebSocketManager'
...
describe('WebSocketManager', () => {
  ...
  describe('send', () => {
    ...
    it.skip('should handle send errors gracefully', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('Failed to send WebSocket message:', expect.any(Error))
  ...
  describe('reconnection logic', () => {
    ...
    it('should respect max reconnect attempts', () => {
      ...
      // After 10 reconnect attempts, should log max attempts message
      expect(consoleLogSpy).toHaveBeenCalledWith('❌ Maximum reconnection attempts reached')
